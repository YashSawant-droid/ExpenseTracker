...
_My Expenses_ is an Android app designed to keep track of your expenses and income.
...
_My Expenses_ relies on many Open Source libraries and has borrowed code from other Open Source projects :
